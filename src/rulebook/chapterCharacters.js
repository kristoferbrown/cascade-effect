    ...
    >
      ...
      <Section header="Physical Origins">
        <p>
          ...
          increase one Physical Metabolism and adopt one Style. Then it will provide you with 3 prompts. Answering these
          prompts will provide guidance for choosing your next
        ...
        <Section header="Conventional" headerHiddenInPrint>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  The vast majority of people in the world fall into this category. You live a life that wouldn't be
                  unusual in the present day. If you can afford them, you have access to modern conveniences and
                  liberties that others are losing access to.
                </p>
                <p>
        ...
        <Section header="Conscript" headerHiddenInPrint>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  You are a veteran of the world's slow-burning collapse. As the changing climate drives the world
                  towards more cold and hot wars over fuel, water, arable land, or petty squabbles, you've had a first
                  hand experience with the conflicts many only see distantly in their news feeds. Whether you've been
                  directly in a combat role, entangled in espionage, served as an officer, or been involved in
                  organizing an armed resistance movement, you find it difficult to return to civilian life.
                </p>
                <p>
        ...
        <Section header="Elite" headerHiddenInPrint>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  Life has been kind to you. Whether due to pure luck, nepotism, hard work, or the scales of inequality
                  simply working in your favor, you've lived a life of privilege. You have no problem moving in and out
                  of areas that require RFID documentation and you are confident your privilege will keep insulated from
                  the worst of the global upheaval you've heard about in the news.
                </p>
                <p>
            ...
            prompts={
              <ol>
                ...
                <li>
                  ...
                  <strong>I don't.</strong> Your world is the only one that matters. You've fully embraced the oligarchy
          ...
          <OriginPage
            ...
            preamble={
              <>
                {" "}
                <p>
                  In one way or another, you've abandoned traditional society. Maybe you've joined an off-grid community
                  in the Post-National Frontier movement, or maybe you've just struck out on your own. Cheap DIY solar
                  and water condenser projects can sometimes make this possible on small scales. You've destroyed your
                  RFID if you ever had one.
                </p>
                <p>
          ...
          <OriginPage
            ...
            preamble={
              <>
                {" "}
                <p>
                  You are on the run from something. It may be from the law, a stalker, organized crime, an Auditor from
                  the Schedule, a person in power, or some other threat. Regardless of the source of the threat, you no
                  longer have access to a conventional lifestyle. You must either live in hiding, constantly on the
                  move, or under false identities. This is easier in some places, but very difficult in places with RFID
                  laws.
                </p>
                <p>
            ...
            preamble={
              <>
                <p>
                  ...
                  fending for themselves under martial law.
                </p>
                <p>
            ...
            prompts={
              <ol>
                <li>
                  ...
                  <strong>A disaster or a failure of a local resource or supply chain.</strong> Whether it was natural
            ...
            preamble={
              <>
                ...
                <p>
                  ...
                  about this action just clicks for you, as if you've practiced it before but have no memory of it.
                </p>
              </>
            }
            prompts={
              <ol>
                <li>
                  Gain three instances of a <Crosslink target={linkMap.AdvantageAndDisadvantage}>Trait</Crosslink>{" "}
                  called Unknown Skill. You don't realize you have these skills and you do not recall practicing them.
                  Later, when you attempt a Challenge, you can permanently replace one of these
        ...
        <Section header="Awakened" headerHiddenInPrint isClassified>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  <strong>You followed your own path to understanding a hidden truth that others don't.</strong> Whether
                  you came to this conclusion intuitively, from readings on the dark web or in ancient texts, you
                  understand the true nature behind the workings of the universe. This understanding is so fundamental
                  that holding it has made aware of the seemingly supernatural things you may be capable of.
                </p>
                <p>
            ...
            preamble={
              <>
                <p>
                  ...
                  enlightening, or ambiguous, shattered your old worldview and left you with a permanent connection to
                  the unnatural. You didn't just learn a secret, you met its keeper.
                </p>
                <p>
                  Choose one Physical and one Hidden Metabolism and increase them both by 1. You were always talented in
                  these domains.
            ...
            prompts={
              <ol>
                <li>
                  ...
                  <strong>A human with supernatural abilities.</strong> You had close contact with a seemingly normal
                ...
                <li>
                  ...
                  <strong>The world is haunted.</strong> It abounds with intangible disembodied minds. Whether you view
        ...
        <Section header="Created" headerHiddenInPrint isClassified>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  <strong>Your potential was unlocked from the outside.</strong> You are a product of a process, a
                  regimen, an experiment, or an ordeal, that forcibly bridged the gap between your Physical and Hidden
                  Bodies. Whether you sought out this transformation or were subjected to it against your will, you
                  emerged fundamentally altered, your capabilities permanently expanded by forces beyond your own
                  understanding.
                </p>
                <p>
        ...
        <Section header="Dissociated Self" topicKey="dissociatedSelfOrigin" headerHiddenInPrint isClassified>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  <strong>You always felt like something was wrong about your body.</strong> Maybe you saw yourself with
                  a different gender or appearance; maybe it felt like you were a mind awkwardly piloting a body; maybe
                  you wished you could ignore the incessant repeated material demands that having a human body places on
                  you. Whatever the manifestation, you experienced a chronic dissociation of the Self Metabolism, making
                  your physical body feel like a separate, possibly even antagonistic, entity. This experience led
                  directly to you developing a true understanding of the separation and connections between your
                  Physical and Hidden Bodies.
                </p>
                <p>
            ...
            prompts={
              <ol>
                ...
                <li>
                  ...
                  <strong>You eventually learned to embrace what your body can do for you.</strong> You stay active, you
        ...
        <Section header="Dissociated Near" topicKey="dissociatedNearOrigin" headerHiddenInPrint isClassified>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  <strong>You always felt like the was something off about the world around you.</strong> Maybe it all
                  seems like a dream, an illusion, simulation, or some other crude imitation; maybe you felt constrained
                  by the limits it imposed on you; maybe it all just feels meaningless. Whatever the manifestation, you
                  experienced a chronic dissociation of the Near Metabolism, making the physical world feel unreal,
                  unimportant, or untrustworthy. However, this experience led to your gaining an intuition into the
                  hidden space behind all physical spaces.
                </p>
                <p>
        ...
        <Section header="Dissociated Far" topicKey="dissociatedFarOrigin" headerHiddenInPrint isClassified>
          <OriginPage
            ...
            preamble={
              <>
                <p>
                  <strong>You always struggled to relate to other people.</strong> Maybe they always reacted differently
                  than you expected; maybe you couldn't understand how socializing seemed to be natural for others;
                  maybe it was exhausting to be around other people; maybe other people seemed unnatural to you; or
                  maybe you just felt awkward. Whatever the manifestation, you experienced a chronic dissociation of the
                  Far Metabolism, making the other people seem inscrutable or illusory. However, this experience led to
                  sensing more concretely the precise bounds of your Hidden Body, and therefore how to interact with it.
                </p>
                <p>
            ...
            preamble={
              <>
                <p>
                  ...
                  dissociation, an abduction, or drugs rendered you unable to remember this time, or perhaps something
                  even stranger occurred. Whatever happened, afterwards you had a subtle awareness of the Hidden Body
                  and a drive to find answers about the nature of this experience.
                </p>
                <p>
            ...
            preamble={
              <>
                <p>
                  ...
                  danger, maybe you witnessed something overtly supernatural or terrifying, or maybe you had a mental
                  break caused by prolonged stressors, social conflicts, or intense embarrassment. To manage the
                  situation, you tapped into resources you didn't realize you had by connecting with your Hidden Body.
                  Ever since, you've had the feeling that Hidden Space was there, just barely out of reach waiting for
                  you to connect with it again.
                </p>
                <p>
