...
function newArtifact() {
	...
	$('#comp-unmodal #artifact-details').append('<div id="shield-details" style="display:none;"><span id="edit-shield-rowlabel" class="row-label">shield( )</span><span class="detail"><select class="primary-select short" id="edit-shield"><option value="1">1</option><option value="2">2</option><option value="3">3</option></select></span> <span id="edit-durability-detailrow" class="detail-row"><label for="edit-shield-durability">durability( )</label><select class="short" id="edit-shield-durability"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select> </span> <span id="edit-recharge-detailrow" class="detail-row"><label for="edit-shield-recharge">recharge( )</label><select class="short" id="edit-shield-recharge"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select></span> <span id="edit-usability-detailrow" class="detail-row"><label for="edit-shield-usability">usability( )</label><select class="short" id="edit-shield-usability"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select></span></div>');
