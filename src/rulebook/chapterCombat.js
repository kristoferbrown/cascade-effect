      ...
      <Section header="Combat Tactics">
        ...
        <Section header="Cover">
          ...
          <Section header="Partial Cover">
            <p>
              Cover that blocks a significant portion of your body, but not all of it, is partial cover. Depending on
              the position of the cover, it may provide cover in both directions or only one. For example, if you are
            ...
            <p>
              If the path of the attack crosses a space occupied by another person, or the target has or is inflicting
              the Grappled state, the target has partial cover. If the Cover Goal is not met in the attack Challenge,
              any Progress generated by the attack hits the other person instead of the intended target.
            </p>
          </Section>
